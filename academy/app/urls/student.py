...
urlpatterns = [
    ...
    path(
        "students/me/enrollment-charges/",
        StudentMeEnrollmentChargesViewSet.as_view({"get": "list"}),
        name="student-me-enrollment-charges",
    ),
    path(
        "students/me/enrollments/<uuid:pk>/charges",
        StudentMeEnrollmentChargesViewSet.as_view({"get": "list"}),
        name="student-me-enrollment-charges",
    ),
